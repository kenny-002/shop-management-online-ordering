...
export default function HomePage() {
  ...
  const shopPhotos = [
    { url: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=600&q=80', caption: 'Store Front Entrance' },
    { url: 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?auto=format&fit=crop&w=600&q=80', caption: 'Fresh Groceries Aisles' },
    { url: 'https://images.unsplash.com/photo-1608686207856-001b95cf60ca?auto=format&fit=crop&w=600&q=80', caption: 'Organic Produce Display' },
    { url: 'https://images.unsplash.com/photo-1583258292688-d02132293a81?auto=format&fit=crop&w=600&q=80', caption: 'Billing Counter & POS' },
  ];
